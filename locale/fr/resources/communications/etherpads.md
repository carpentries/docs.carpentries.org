...
The Carpentries propose l'utilisation de nos [Etherpads] (https://pad.carpentries.org/) comme outil de prise de notes collaboratif lors d'ateliers, d'événements de formation et d'autres événements en lien avec The Carpentries.  Une liste de nos blocs-notes les plus couramment utilisés et d'autres ressources se trouvent sur notre [pad-of-pads] (https://pad.carpentries.org/pad-of-pads). Cette liste est créée manuellement et ne comprend généralement que des blocs-notes présentant un intérêt pour la communauté en général.  Elle n'inclura pas de blocs-notes spécifiques à des événements individuels ou à des groupes.

Un nouvel Etherpad peut être créé en ajoutant un nom descriptif à l'URL https://pad.carpentries.org/, tel que https://pad.carpentries.org/committeename.

Les blocs-notes sont synchronisés au fur et à mesure que vous tapez, de sorte que tous ceux qui consultent cette page voient le même texte. Cela permet à tout le monde de collaborer avec fluidité sur des documents.
