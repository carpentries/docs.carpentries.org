...
Cette politique s'applique à tous les cas dans lesquels vous utilisez le nom/logo de The Carpentries.

### Utilisations ne nécessitant pas d'approbation préalable

Il est toujours permis de déclarer qu'un atelier est un atelier The Carpentries ou qu'un atelier est basé sur du matériel de The Carpentries.

Il est acceptable d'utiliser la marque déposée pour reconnaître ou créditer The Carpentries dans des articles de journaux, des présentations de conférences, des discours liminaires, des demandes de subvention, etc. En cas de reconnaissance ou d'attribution, vous pouvez utiliser le terme « The Carpentries » ou les logos inchangés pour l'indiquer, sans notre approbation préalable.
...
The Carpentries compte un certain nombre de communautés locales et spécifiques à un domaine. Nous encourageons le développement de logos dérivés/modifiés qui indiquent la localisation ou l'objectif du groupe. Afin de soutenir le développement de logos spécifiques à un domaine et à une région, nous avons décrit ci-dessous les modifications approuvées apportées au logo et au mot-symbole The Carpentries.

Les couleurs de la « clé à molette » peuvent être modifiées en fonction de votre domaine/région, mais aucune forme ou distorsion ajoutée (y compris l'orientation) n'est autorisée. Le nom de domaine/région de votre groupe doit être ajouté sous The Carpentries en rouge Carpentries (Hex : FF4955).
...
Si vous êtes un membre local de The Carpentries et que vous souhaitez modifier le logo conformément à ces directives, veuillez envoyer un e-mail à [community@carpentries.org] (mailto:carpentries.org) et nous approuverons votre modification ou vous aiderons à créer la version modifiée.
...
L'utilisation du nom ou du logo de The Carpentries en conjonction ou en combinaison avec le nom ou le logo d'un autre groupe (par exemple : utiliser le symbole clé à molette aux couleurs d'une autre organisation ou ajouter des éléments du logo d'une autre organisation à The Carpentries) est interdite.
...
## Liens vers les fichiers de logo
...
Des arrière-plans virtuels comportant les logos des programmes de cours de The Carpentries peuvent être téléchargés et utilisés dans le [référentiel GitHub de Carpentries Commons] (https://github.com/carpentries/commons/tree/main/virtual-backgrounds).
