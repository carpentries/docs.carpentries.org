...
The Carpentries imparte cientos de talleres cada año, lo que significa que los materiales de la lección
...
- Evalúe todas las contribuciones utilizando el modelo pedagógico de The Carpentries:
...
- Rutinariamente:
  - Garantizar un tiempo de respuesta razonable a todos los problemas y relaciones públicas enviados. Como mínimo, garantizar que todos los problemas y relaciones públicas se reconozcan en el plazo de una semana.
...
- Dar comentarios a los colaboradores que utilizan el modelo de The Carpentries:
  ...
  - Usa un lenguaje motivador.

- Evaluar las contribuciones a las lecciones a la luz del modelo pedagógico de The Carpentries descrito anteriormente.
...
Se enviará un correo electrónico anual con una breve encuesta a los mantenedores en
...
- {{'[El canal #maintainers solo por invitación] ({}/archives/C8H5LN44V) '.format (slack)}} del espacio de trabajo de Slack de The Carpentries es una plataforma para que toda la comunidad haga preguntas y participe en debates sobre el tema del mantenimiento de las clases. Si eres un mantenedor y aún no tienes acceso a este canal, ponte en contacto con el [Equipo del plan de estudios] (mailto:curriculum@carpentries.org).
...
Las llamadas mensuales de Maintainer figuran en nuestro
{{'[Community Calendar] ({}/community/events/) '.format (carpentries_website)}}. Si tiene previsto asistir a una próxima reunión, [regístrese en Pretix] (https://pretix.carpentries.org/lesson-maintainers/lesson-maintainers-meetings/).
Pretix calculará automáticamente la hora del evento en tu zona horaria local y te enviará una invitación de calendario y recordatorios de eventos.
...
- [Maintainer Resources] (https://github.com/carpentries/maintainer-resources): un lugar para leer las actas de las llamadas de la comunidad de mantenedores y consejos útiles sobre las reglas de vuelo.
...
de los más relevantes para los mantenedores.
...
de Carpentries incluye {{'[una página de búsqueda de ayuda] ({}/lessons/help_wanted) '.format (carpentries_website)}}, que puede
...
Carpentry, Software Carpentry, CarpentriesLab y The Carpentries Incubator. Descubre cómo
...
, por ejemplo, el permiso parental, la temporada de exámenes, etc.), puede ser útil que tus compañeros de
Maintainer y posibles colaboradores se lo hagas saber. Estas son las medidas
...
2. Informe a sus comantenedores:
   ...
   8. Si necesitas ayuda para encontrar la información de contacto de alguno de tus compañeros de mantenimiento
      , ponte en contacto con el [Equipo curricular] (mailto:curriculum@carpentries.org).
...
para que los mantenedores puedan editar y previsualizar sus lecciones
en su ordenador, cómo inicializar una nueva lección y utilizar los distintos elementos de
de la plantilla de lección, y cómo mantenerse al día con
...
pueden seguir el plan de estudios en su tiempo libre o indicar su interés en unirse a una sesión de capacitación
enviando un correo electrónico al [Equipo del plan de estudios] (mailto:curriculum@carpentries.org).
...
Sin embargo, si los cambios son pequeños y corrigen algo que, sin lugar a dudas, no funciona en la lección (por ejemplo, un enlace roto, alguna sintaxis mal formada o algo similar), puede combinar sus propios cambios de inmediato.
