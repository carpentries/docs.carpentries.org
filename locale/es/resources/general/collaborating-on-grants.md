...
Entre los financiadores que ayudan a The Carpentries a cumplir nuestra misión y visión _**financieramente**_ se encuentran [organizaciones asociadas] (https://carpentries.org/support/partnership/partner-list/) y fundaciones caritativas. The Carpentries se financia actualmente con subvenciones (~ 16%), asociaciones (~ 68%), tarifas programáticas (~ 15%) y otras fuentes, incluidas las donaciones. Nuestro objetivo es ser transparentes en cuanto a nuestras fuentes de ingresos y a la forma en que se alinean con nuestra visión y valores, y buscamos financiación para apoyar las prioridades actuales y los objetivos futuros en consonancia con nuestro {{'[plan estratégico] ({}/about-us/strategic-plan/) '.format (carpentries_website)}}.
