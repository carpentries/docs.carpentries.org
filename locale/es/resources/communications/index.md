...
- [Guía para compartir comunicados con The Carpentries](sharing_resources.md)
...
## Respuestas y comunicados ante determinadas situaciones

- [Manual de respuestas y comunicados ante determinadas situaciones de The Carpentries](https://docs.google.com/document/d/1X0wH75oScgVsfLVxTIwhAdW4WRivZfxSTDFxXUsexXw/)

## Estilos, identidad de la marca y logotipos

- [Guía de estilo](style-guide.md)
- [Etiquetas para publicaciones de blog de The Carpentries](select-blog-tags.md)
- [Identidad de la marca](brand_identity.md)
- [Logotipos de The Carpentries](logos.md)
