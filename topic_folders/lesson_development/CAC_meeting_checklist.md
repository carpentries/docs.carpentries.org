...
- [Secretary] Start scheduling meeting using this [email template](). 
- [Secretary] Determine the best meeting time (or two if needed) from the availability poll. 
  Create an event time announcement using TimeandDate (or similar service). Include event time announcement link 
  in all communications about meeting times. 
...
- [Secretary] Send meeting announcement using this [template]().
...
- [Secretary] Send meeting reminder using this [template]().
...
### Meeting Followup to CAC Members
