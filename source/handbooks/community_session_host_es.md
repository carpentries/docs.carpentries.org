...
sigan [el Código de conducta de The Carpentries](https://docs.carpentries.org/policies/coc/).  Puedes encontrar una descripción de las herramientas enumeradas en el [glosario de la comunidad](https://docs.carpentries.org/resources/general/glossary.html).
