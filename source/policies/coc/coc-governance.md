...
The Board of Directors (BoDs) will be notified about any new members. 
The BoDs has oversight of the governance of the Code of Conduct Committee but will have no influence over potential incidents and their resolutions.

## Onboarding

The onboarding process is determined by the Committee, and the BoDs will be kept informed about this process.
New members, including the Staff and BoDs Liaison, are not immediately seated on the Committee and thus not included in issue resolution until after onboarding is completed.
...
The Committee, in addition, has a liaison from the Carpentries Core Team and a liaison from the BoDs.
...
Based on these areas of work, all area leads along with the Core Team and BoDs Liaisons will seek to improve the CoC policies and procedures. 
...
The Carpentries Core Team and BoDs liaisons can vote on matters such as election of chairs and area leads.
...
Should the BoDs liaison participate in a CoCc vote, and that resolution is appealed before the BoDs, the liaison member will abstain from that appeal vote.
...
### The Carpentries Core Team Liaison
...
- An Incident Response Group must contain at least one member who has handled a live incident as part of a previous Incident Response Group within The Carpentries CoCc or have attended a CoC training organised by CoCc/Core Team.
